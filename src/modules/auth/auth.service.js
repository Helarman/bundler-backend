...
var AuthService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        user = _a.sent();
                        return [2 /*return*/, this.signTokens(user.id, user.email)];
                }
            });
        });
    };
    AuthService.prototype.signin = function (dto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.validateUser(dto.email, dto.password)];
                    case 1:
                        user = _a.sent();
                        if (!user) {
    ...
    AuthService.prototype.refreshTokens = function (userPayload) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(userPayload === null || userPayload === void 0 ? void 0 : userPayload.email)) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, argon.verify(user.password, pass)];
                    case 2:
                        _a = (_b.sent());
                        _b.label = 3;
                    case 3:
    ...
    AuthService.prototype.signTokens = function (userId, email) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, accessToken, refreshToken, _b, _c;
            var _d, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, Promise.all([
                            this.jwt.signAsync({ sub: userId, email: email }, {
                    ...
                    case 1:
                        _a = _f.sent(), accessToken = _a[0], refreshToken = _a[1];
                    ...
                    case 2: return [4 /*yield*/, _c.apply(_b, [(_d.data = (_e.refreshToken = _f.sent(), _e),
                                _d)])];
                    case 3:
                        _f.sent();
