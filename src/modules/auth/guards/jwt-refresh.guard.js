...
var JwtRefreshGuard = /** @class */ (function (_super) {
    ...
    JwtRefreshGuard.prototype.getRequest = function (context) {
        var _a;
        var request = context.switchToHttp().getRequest();
        if ((_a = request.body) === null || _a === void 0 ? void 0 : _a.refreshToken) {
            request.headers.authorization = "Bearer ".concat(request.body.refreshToken);
        }
        return request;
    };
    JwtRefreshGuard.prototype.handleRequest = function (err, user) {
        if (err || !user) {
