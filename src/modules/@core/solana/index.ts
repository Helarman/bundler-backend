...
export class Solana {
  public static systemProgramId = new PublicKey("11111111111111111111111111111111");
  public static rentProgramId = new PublicKey("SysvarRent111111111111111111111111111111111");
  public static tokenProgramId = new PublicKey("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA");
  public static associatedTokenProgramId = new PublicKey("ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL");
  public static mplTokenMetadataProgramId = new PublicKey("metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s");
