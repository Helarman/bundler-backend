        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.jetonService.getRouteQuote(dto.tokenMintAddress, dto.amount, dto.action, dto.rpcUrl)];
                    case 2:
                        result = _a.sent();
                    ...
                    case 3:
                        error_1 = _a.sent();
                        this.logger.error('Route quote error:', error_1);
                        return [2 /*return*/, {
                                success: false,
