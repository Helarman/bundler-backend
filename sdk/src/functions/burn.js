 ...
 */
var getBurnTransaction = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                ...
                (0, utils_1.debugLog)('   URL:', "".concat(apiUrl, "/api/tokens/burn"));
                (0, utils_1.debugLog)('   Payload:', JSON.stringify(requestPayload, null, 2));
                return [4 /*yield*/, fetch("".concat(apiUrl, "/api/tokens/burn"), {
                        method: 'POST',
            ...
            case 5:
                error_1 = _f.sent();
                (0, utils_1.debugError)('Error getting burn transaction:', error_1);
                throw error_1;
 ...
 */
var validateBurnInputs = function (wallet, tokenAddress, amount) {
 ...
 * Execute token burn
 */
var burnToken = function (wallet, tokenAddress, amount) { return __awaiter(void 0, void 0, void 0, function () {
    var validation, walletAddress, burnResult, walletKeypair, fullySignedTransactions, burnBundles, results, i, bundle, result, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 7, , 8]);
                validation = (0, exports.validateBurnInputs)(wallet, tokenAddress, amount);
                if (!validation.valid) {
                    return [2 /*return*/, {
                            success: false,
                ...
                walletAddress = (0, utils_1.getWalletAddress)(wallet.privateKey);
                console.log("Preparing to burn ".concat(amount, " tokens from ").concat(walletAddress));
                console.log("Token address: ".concat(tokenAddress));
                return [4 /*yield*/, getBurnTransaction({
            ...
            case 1:
                burnResult = _a.sent();
                console.log("Received ".concat(burnResult.transactions.length, " partially prepared transaction(s) from backend"));
                walletKeypair = (0, utils_1.createKeypairFromPrivateKey)(wallet.privateKey);
                fullySignedTransactions = (0, utils_1.completeTransactionSigning)(burnResult.transactions, walletKeypair, new Map() // No additional keypairs needed for burn
                );
                console.log("Completed signing for ".concat(fullySignedTransactions.length, " transactions"));
                burnBundles = (0, utils_1.prepareTransactionBundles)(fullySignedTransactions);
                console.log("Prepared ".concat(burnBundles.length, " burn bundles"));
                results = [];
                i = 0;
                _a.label = 2;
            case 2:
                if (!(i < burnBundles.length)) return [3 /*break*/, 6];
                bundle = burnBundles[i];
                console.log("Sending bundle ".concat(i + 1, "/").concat(burnBundles.length, " with ").concat(bundle.transactions.length, " transactions"));
                return [4 /*yield*/, (0, utils_1.sendBundle)(bundle.transactions)];
            case 3:
                result = _a.sent();
                results.push(result);
                if (!(i < burnBundles.length - 1)) return [3 /*break*/, 5];
            ...
            case 7:
                error_2 = _a.sent();
                console.error('Burn error:', error_2);
                return [2 /*return*/, {
                        success: false,
 ...
 * Batch burn tokens
 */
var batchBurnToken = function (wallet, burns) { return __awaiter(void 0, void 0, void 0, function () {
    var results, i, burn, burnResult, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 6, , 7]);
                console.log("Starting batch burn with ".concat(burns.length, " burns"));
                ...
                _a.label = 1;
            case 1:
                if (!(i < burns.length)) return [3 /*break*/, 5];
                burn = burns[i];
                console.log("Processing burn ".concat(i + 1, "/").concat(burns.length));
                return [4 /*yield*/, (0, exports.burnToken)(wallet, burn.tokenAddress, burn.amount)];
            case 2:
                burnResult = _a.sent();
                if (!burnResult.success) {
                    return [2 /*return*/, {
                            success: false,
                            results: results,
                            error: "Burn ".concat(i + 1, " failed: ").concat(burnResult.error)
                        }];
                }
                // Add burn result
                results.push(burnResult.result);
                if (!(i < burns.length - 1)) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, utils_1.delay)(1000)];
            case 3:
                _a.sent(); // 1 second delay between burns
                _a.label = 4;
            case 4:
                i++;
                return [3 /*break*/, 1];
            ...
            case 6:
                error_3 = _a.sent();
                console.error('Batch burn error:', error_3);
                return [2 /*return*/, {
                        success: false,
