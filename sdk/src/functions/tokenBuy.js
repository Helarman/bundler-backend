 ...
 */
var getTokenBuyTransactions = function (walletAddresses, tokenConfig, customAmounts) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                (0, utils_1.debugLog)('🔗 [DEBUG] Getting token buy transactions from:', "".concat(baseUrl, "/api/tokens/buy"));
                ...
                return [4 /*yield*/, fetch("".concat(baseUrl, "/api/tokens/buy"), {
                        method: 'POST',
                        headers: {
            ...
            case 5:
                error_1 = _b.sent();
                (0, utils_1.debugError)('Error getting token buy transactions:', error_1);
                throw error_1;
 ...
 */
var buyTokenSingle = function (wallet, tokenConfig) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 8, , 9]);
                console.log("\uD83D\uDE80 Starting single token buy for ".concat(tokenConfig.protocol, " protocol"));
                console.log("\uD83D\uDCDD Token: ".concat(tokenConfig.tokenAddress));
                console.log("\uD83D\uDCB0 Amount: ".concat(tokenConfig.solAmount, " SOL"));
                validation = (0, exports.validateTokenBuyInputs)([wallet], tokenConfig);
                if (!validation.valid) {
                    return [2 /*return*/, {
                            success: false,
                ...
                return [4 /*yield*/, getTokenBuyTransactions([walletAddress], tokenConfig)];
            case 1:
 ...
 */
var buyTokenBatch = function (wallets, tokenConfig, customAmounts) { return __awaiter(void 0, void 0, void 0, function () {
    var validation, walletKeypairs_1, walletAddresses, partiallyPreparedBundles, signedBundles, results, i, bundle, result, error_3, errorMessage;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 8, , 9]);
                console.log("\uD83D\uDE80 Starting batch token buy for ".concat(tokenConfig.protocol, " protocol"));
                console.log("\uD83D\uDCDD Token: ".concat(tokenConfig.tokenAddress));
                console.log("\uD83D\uDC65 Wallets: ".concat(wallets.length));
                console.log("\uD83D\uDCB0 Amount: ".concat(tokenConfig.solAmount, " SOL per wallet"));
                validation = (0, exports.validateTokenBuyInputs)(wallets, tokenConfig);
                if (!validation.valid) {
                    return [2 /*return*/, {
                            success: false,
                            error: validation.error
                ...
                return [4 /*yield*/, getTokenBuyTransactions(walletAddresses, tokenConfig, customAmounts)];
            case 1:
                partiallyPreparedBundles = _a.sent();
                console.log("\uD83D\uDCE6 Received ".concat(partiallyPreparedBundles.length, " bundles from backend"));
                signedBundles = partiallyPreparedBundles.map(function (bundle) {
 ...
 */
var validateTokenBuyInputs = function (wallets, tokenConfig) {
